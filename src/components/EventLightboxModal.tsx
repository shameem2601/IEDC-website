        ...
        >
          ...
          <div className="p-4 sm:px-6 py-4 bg-white border-t border-[#e5e5e5] flex flex-col sm:flex-row items-center justify-between gap-4 font-instrument">
            <div className="flex items-center gap-2 text-xs text-[#666666]">
              <span className={`w-1.5 h-1.5 rounded-[1px] ${isPast ? 'bg-neutral-400' : 'bg-[#888888]'}`} />
              <span>
                {isPast
            ...
            <div className="flex items-center gap-3 w-full sm:w-auto">
              {isPast ? (
                <div className="px-5 py-2 rounded-[2px] font-medium text-xs bg-[#fafaf9] text-neutral-600 border border-[#e5e5e5] flex items-center justify-center gap-2">
                  <CheckCircle2 className="w-3.5 h-3.5 text-neutral-400" />
                  <span>Event Concluded · Archived</span>
                </div>
              ) : (
                <button
                  type="button"
